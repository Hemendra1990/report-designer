    ...
    <div className="min-h-screen bg-muted/40">
      ...
      <main className="container mx-auto py-8 px-4">
        ...
        <div className="mb-8 flex flex-col md:flex-row md:justify-between md:items-center gap-4">
          <div>
            <h1 className="text-3xl font-bold mb-2">Report Types</h1>
        ...
        <div id="results-top" className="bg-background rounded-lg shadow-sm border mb-6 p-4">
                  ...
                  >
                    <Card className="overflow-hidden hover:shadow-md transition-shadow duration-300">
                      <CardContent className="p-0">
                        <div className="p-6 grid md:grid-cols-[auto_1fr_auto] gap-6 items-start">
                          {/* Report Type Icon & Type */}
                          ...
                          <div className="space-y-3">
                            <div className="flex items-center gap-3">
                              <h3 className="text-xl font-medium">{reportType.name}</h3>
                              ...
                              <div className="text-xs text-muted-foreground">{reportType.id}</div>
                            </div>
                            <p className="text-muted-foreground">{reportType.description}</p>
                            <div className="flex flex-wrap gap-x-6 gap-y-2 text-sm">
                              <div>
                                <span className="text-muted-foreground">Primary Object:</span> {reportType.primaryObject}
                              </div>
                              <div>
                                <span className="text-muted-foreground">Related:</span> {reportType.relatedObjects.join(", ")}
                              </div>
                              <div>
                                <span className="text-muted-foreground">Created:</span> {formatDate(reportType.createdDate)}
                              </div>
                              <div>
                                <span className="text-muted-foreground">Last Modified:</span> {formatDate(reportType.lastModified)}
                              </div>
                              <div>
                                <span className="text-muted-foreground">Views:</span> {reportType.views.toLocaleString()}
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="flex flex-col gap-2">
                            ...
                            <Button variant="outline" size="sm" className="w-full justify-start text-red-500 hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-950/20">
                              <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="14"
                                height="14"
